...
<script type="text/javascript">
		...
		$.ajax({
			...
			success:function(data){
				...
				if(jenis == 'dpp') {
					...
					$($($("#detailNameRW").parent('div')).parent('div')).hide();
					$($($("#detailNameRT").parent('div')).parent('div')).hide();
					$("#detailNameStruk").text(resp['struk_dpd_nama']);
					$("#detailNameBio").text(resp['fullName']);
				} else if(jenis == 'dpc') {
					$("#detailNameProv").text(resp['geo_prov_nama']);
					...
					$($($("#detailNameRW").parent('div')).parent('div')).hide();
					$($($("#detailNameRT").parent('div')).parent('div')).hide();
					$("#detailNameStruk").text(resp['struk_dpc_nama']);
					$("#detailNameBio").text(resp['fullName']);
				} else if(jenis == 'pac') {
					$("#detailNameProv").text(resp['geo_prov_nama']);
					$("#detailNameKab").text(resp['geo_kab_nama']);
	...
	function detailStatistik(id){
		$.ajax({
			...
			$("#kabupaten").text(changeNumberFormat(resp['pengurus_dpc_ada'])+"/"+changeNumberFormat(resp['pengurus_dpc'])+" ("+changePercent(resp['pengurus_dpc_ada'],resp['pengurus_dpc'])+" %)");
