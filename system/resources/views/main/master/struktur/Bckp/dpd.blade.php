		...
		@foreach($data as $tmp)
			<tr>
				...
				<td>
					...
					<a href="{{ asset('proses/delete/struktur/dpd/'.$tmp->geo_prov_id.'/'.$tmp->struk_pimda_id) }}" onclick="return confirm('Apakah anda yakin ingin menghapus data ini?');" class="btn btn-danger" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Delete"><i class="fa fa-trash"></i></a>
