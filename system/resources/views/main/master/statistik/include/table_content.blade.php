...
@section('table_data')
	...
	<td>{{ number_format($tmp->pengurus_dpc_ada,0,',','.') }} / {{ number_format($tmp->pengurus_dpc,0,',','.') }}</td>
	<td>{{ number_format($tmp->pengurus_pac_ada,0,',','.') }} / {{ number_format($tmp->pengurus_pac,0,',','.') }}</td>
