						...
						<div class="box-header with-border">
							<div class="row">
								...
								<div class="@yield('add-button','show') col-md-2 col-sm-3 col-xs-6 pull-right">
									<div class="@yield('add-button','show') btn-warning btn-block btn" data-toggle="modal" data-target="#modal-input-struk" onclick="actionTambah()"><i class="fa fa-plus"></i> Tambah</div>
								</div>
								<div class="@yield('download-button','show') col-md-2 col-sm-3 col-xs-6 pull-right">
									<div class="btn-warning btn-block btn" onclick="actionDownload('excel','statistik','all')"><i class="fa fa-print"></i> Excel</div>
								</div>
								<div class="@yield('download-button','show') col-md-2 col-sm-3 col-xs-6 pull-right">
									<div class="btn-warning btn-block btn" onclick="actionDownload('pdf','statistik','all')"><i class="fa fa-print"></i> PDF</div>
								</div>
							</div>
						</div>
...
function actionEdit(targetId) {
	...
	jQuery('#form-input-struk').attr('action',"{{url()}}/@yield('content_action_edit')"+targetId);
...
function actionTambah(){
	jQuery('#form-input-struk').attr('action',"{{url()}}/@yield('content_action_tambah')");
	jQuery('#submiter').text('Tambah');
	jQuery('#myModalLabel').text('Tambah @yield('modal_struk_tipe')');
}
 (function($){
