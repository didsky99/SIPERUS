	...
	<thead>
		...
		@foreach($dataReport as $tmp)				
			<tr>
				...
				<td class="yellow center">{{ number_format($tmp->pengurus_dpc,0, "." , ",") }}</td>
				<td class="center">{{ number_format($tmp->pengurus_dpc_ada,0, "." , ",") }}</td>
				<td class="center red-text" style="color: #FF0000;">{{ number_format($tmp->pengurus_dpc-$tmp->pengurus_dpc_ada,0, "." , ",") }}</td>
