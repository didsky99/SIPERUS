	...
	<div class="col-md-12">
		...
		<div class="form-group">
			<div class="row">
				...
				<div class="col-md-8 col-sm-8 col-xs-9">
					<select class="form-control" id="abProv" name="abProv">
		...
		<div class="form-group">
			<div class="row">
				...
				<div class="col-md-8 col-sm-8 col-xs-9">
					<select class="form-control" id="abKab" name="abKab">
		...
		<div class="form-group">
			<div class="row">
				...
				<div class="col-md-8 col-sm-8 col-xs-9">
					<select class="form-control" id="abKec" name="abKec">
		...
		<div class="form-group">
			<div class="row">
				...
				<div class="col-md-8 col-sm-8 col-xs-9">
					<input type="text" name="email" class="form-control" id="emailBalon" placeholder="Email">
				</div>
			</div>
		</div>	
		<div class="form-group">
		...
		<div class="form-group">
			<div class="row">
				...
				<div class="col-md-8 col-sm-8 col-xs-9">
					<input type="text" name="noSK" id="noSK" class="form-control" placeholder="No SK Mandat" required>				
				</div>
			</div>
		</div>
		<div class="form-group">
			<div class="row">
				...
				<div class="col-md-8 col-sm-8 col-xs-9">
					<input type="date" name="dateSK" id="dateSK" class="form-control" placeholder="Date SK Mandat" required="">				
				</div>
			</div>
		</div>	
		<div class="form-group">
			<div class="row">
				...
				<div class="col-md-8 col-sm-8 col-xs-9">
					<input type="file" name="foto" id="foto" class="form-control" placeholder="File SK Mandat" required>				
					<h6>(Max 10MB, /pdf)</h6>
				</div>
			</div>
		</div>
